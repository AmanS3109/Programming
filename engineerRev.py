...
if not os.environ.get("ONLINE_JUDGE"):  # Simulating the `#ifndef ONLINE_JUDGE`
    sys.stdin = open('in.txt', 'r')   # Redirect input from 'in.txt'
    sys.stdout = open('out.txt', 'w') # Redirect output to 'out.txt'
import time
